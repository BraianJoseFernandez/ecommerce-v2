...
<form action="{{ route('admin.covers.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <figure class="relative">
        ...
        <img src="{{ asset('img/no-image.png') }}" alt="Portada" class="w-full aspect-[3/1] object-cover object-center" id="img-preview">
    </figure>
    ...
    <div class="mb-4 mt-4">
        ...
        <x-input name="title" value="{{ old('title') }}" class="w-full"  placeholder="Ingresa el titulo de la portada"/>
    </div>
